...
// Updated ClockIcon for Logbook FAB (filled version)
export const ClockIcon: React.FC<{className?: string, fill?: string}> = ({ className, fill = "currentColor" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fill} className={className || "w-6 h-6"}>
...
// Corrected BookOpenIcon to handle specific filled FAB version (32x32) and standard outline version
export const BookOpenIcon: React.FC<{className?: string, fill?: string}> = ({ className, fill = "none" }) => {
  if (fill !== "none" && fill !== "currentColor") { 
    return (
      <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill={fill} className={className || "w-8 h-8"}>
...
export const CogIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94a.75.75 0 01.991-.018l.09.074c.09.073.19.138.297.195.286.155.597.273.926.345.305.066.62.099.943.099s.638-.033.943-.099c.329-.072.64-.19.926-.345a3.999 3.999 0 001.272-1.121 4.02 4.02 0 00.32-.47.75.75 0 111.316.763c-.07.121-.148.236-.232.345a5.52 5.52 0 01-.64.636 5.485 5.485 0 01-1.77 1.253 5.501 5.501 0 01-2.284.526h-.002c-.815 0-1.606-.2-2.284-.526a5.485 5.485 0 01-1.77-1.253 5.52 5.52 0 01-.64-.636A4.017 4.017 0 014.5 4.717a.75.75 0 111.316-.763c.074.128.156.252.245.368.287.368.618.693.985.967.291.218.61.393.953.518.299.108.616.162.94.162h.001c.324 0 .641-.054.94-.162a4.01 4.01 0 001.938-1.485c.002-.002.003-.003.004-.005a.75.75 0 01.995-.052M12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.5a.75.75 0 01.75-.75H6a.75.75 0 010 1.5H3.75A.75.75 0 013 13.5zm18 0a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H21.75a.75.75 0 01-.75-.75zm-15.002-9a.75.75 0 01.75-.75H6a.75.75 0 010 1.5H3.75A.75.75 0 013 4.5zm18 0a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H21.75a.75.75 0 01-.75-.75zM4.06 7.19a.75.75 0 010 1.06l-1.5 1.5a.75.75 0 01-1.06-1.06l1.5-1.5a.75.75 0 011.06 0zm14.82 0a.75.75 0 011.06 0l1.5 1.5a.75.75 0 11-1.06 1.06l-1.5-1.5a.75.75 0 010-1.06zM4.06 15.75a.75.75 0 011.06 0l-1.5 1.5a.75.75 0 11-1.06-1.06l1.5-1.5zm15.88-1.06a.75.75 0 010 1.06l-1.5 1.5a.75.75 0 01-1.06-1.06l1.5-1.5a.75.75 0 011.06 0z"/>
  </svg>
);
...
export const DocumentDuplicateIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-5 h-5"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a.75.75 0 0 1-.75-.75V11.25m3.75-1.5-3.75-3.75m3.75 3.75-3.75-3.75" />
    </svg>
);

export const SunIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-.386 1.591-1.591M3 12h2.25m.386-6.364 1.591 1.591M12 12a2.25 2.25 0 0 0-2.25 2.25c0 1.37.56 2.595 1.5 3.401L12 21l.75-2.25A4.47 4.47 0 0 0 14.25 15a4.507 4.507 0 0 0-1.732-3.322A4.5 4.5 0 0 0 12 12Z" />
  </svg>
);
...
export const CalendarDaysIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-3.75h.008v.008H12v-.008Zm0 3.75h.008v.008H12v-.008Zm0 3.75h.008v.008H12v-.008Zm3-3.75h.008v.008H15v-.008Zm0 3.75h.008v.008H15v-.008Zm0 3.75h.008v.008H15v-.008Zm3-3.75h.008v.008H18v-.008Zm0 3.75h.008v.008H18v-.008Zm0 3.75h.008v.008H18v-.008Zm-9-3.75h.008v.008H9v-.008Zm0 3.75h.008v.008H9v-.008Zm0 3.75h.008v.008H9v-.008Z" />
  </svg>
);

export const ClipboardIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375m0-13.5h3.375m0 0h3.375m-3.375 0V1.5m0 3.375c0 .621.504 1.125 1.125 1.125h3.375c.621 0 1.125-.504 1.125-1.125V1.5m-6.75 0h3.375" />
  </svg>
);
...
export const DocumentArrowUpIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m1.5 12.75v-6m0 0l-3 3m3-3l3 3m-6 3H5.625a1.125 1.125 0 01-1.125-1.125V6.375a1.125 1.125 0 011.125-1.125h12.75c.621 0 1.125.504 1.125 1.125V11.25a9 9 0 00-9 9z" />
    </svg>
);
...
export const CalculatorIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-4.5-2.25v2.25m-4.5-2.25v2.25M9 9.75h.008v.008H9V9.75zm3.75 0h.008v.008h-.008V9.75zm3.75 0h.008v.008h-.008V9.75zM5.25 6H18.75a2.25 2.25 0 012.25 2.25v6.75a2.25 2.25 0 01-2.25-2.25H5.25a2.25 2.25 0 01-2.25-2.25V8.25a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667 0l-3.181 3.183m0 0l-3.181-3.183m0 0h16.5m-16.5 0l3.181-3.183a8.25 8.25 0 0111.667 0l3.181 3.183" />
    </svg>
);